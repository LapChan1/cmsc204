...
public class NotationTest {
	...
	@Test
	public void testComplexConvertInfixToPostfix() throws StackUnderflowException, QueueOverflowException, StackOverflowException, InvalidNotationFormatException {
		String postfixResult = Notation.convertInfixToPostfix(complexInfix);
		assertEquals(complexPostfix, postfixResult);
	}
	
	@Test
	public void testIntermediateConvertInfixToPostfix() throws StackUnderflowException, QueueOverflowException, StackOverflowException, InvalidNotationFormatException {
		String postfixResult = Notation.convertInfixToPostfix(intermediateInfix);
		assertEquals(intermediatePostfix, postfixResult);
	}
	
	@Test
	public void testEasyConvertInfixToPostfix() throws StackUnderflowException, QueueOverflowException, StackOverflowException, InvalidNotationFormatException {
		String postfixResult = Notation.convertInfixToPostfix(easyInfix);
		assertEquals(easyPostfix, postfixResult);
	}
	
	@Test
	public void testInvalidInfixExpression() throws StackUnderflowException, QueueOverflowException, StackOverflowException {
		try{
	...
	@Test
	public void testComplexConvertPostfixToInfix() throws StackOverflowException, InvalidNotationFormatException, StackUnderflowException {
		String infixResult = Notation.convertPostfixToInfix(complexPostfix);
		assertEquals(complexInfix, infixResult);
	}
	
	@Test
	public void testIntermediateConvertPostfixToInfix() throws StackOverflowException, InvalidNotationFormatException, StackUnderflowException {
		String infixResult = Notation.convertPostfixToInfix(intermediatePostfix);
		assertEquals(intermediateInfix, infixResult);
	}
	
	@Test
	public void testEasyConvertPostfixToInfix() throws StackOverflowException, InvalidNotationFormatException, StackUnderflowException {
	...
	@Test
	public void testComplexEvaluatePostfixExpression() throws NumberFormatException, StackOverflowException, InvalidNotationFormatException, StackUnderflowException {
		double result = Notation.evaluatePostfixExpression(complexPostfix);
		assertEquals(evalComplexPostfix, result, .001);
	}
	
	@Test
	public void testIntermediateEvaluatePostfixExpression() throws NumberFormatException, StackOverflowException, InvalidNotationFormatException, StackUnderflowException {
		double result = Notation.evaluatePostfixExpression(intermediatePostfix);
		assertEquals(evalIntermediatePostfix, result, .001);
	}
	
	@Test
	public void testEasyEvaluatePostfixExpression() throws NumberFormatException, StackOverflowException, InvalidNotationFormatException, StackUnderflowException {
		double result = Notation.evaluatePostfixExpression(easyPostfix);
		assertEquals(evalEasyPostfix, result, .001);
	}
	
	@Test
	public void testInvalidPostfixExpressionA() throws NumberFormatException, StackOverflowException, StackUnderflowException {
		try{
