	...
	private class ButtonEventHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent e) {
			...
			if (e.getSource() == conversionBtn) {
				...
				catch (InvalidNotationFormatException | StackUnderflowException | QueueOverflowException | StackOverflowException exception)
				{
				...
				catch (InvalidNotationFormatException | NumberFormatException | StackOverflowException | StackUnderflowException exception)
				{
					JOptionPane.showMessageDialog(null, exception.getMessage());
				}
