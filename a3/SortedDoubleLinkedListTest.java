...
public class SortedDoubleLinkedListTest {
	...
	public double d1 =80.8;
	public double d2 =-6.6;
	public double d3 =5.1;
	public double d4 =1.2;
	public double d5 =3.5;
	public double d6 = 100.5;
	...
	public void testIteratorSuccessfulDoubleNext() {
		sortedLinkedDouble.add(d1);
		sortedLinkedDouble.add(d2);
		sortedLinkedDouble.add(d3);
		sortedLinkedDouble.add(d4);
		ListIterator<Double> iterator = sortedLinkedDouble.iterator();
		assertEquals(true, iterator.hasNext());
		assertTrue(d2==iterator.next());
		assertTrue(d4==iterator.next());
		assertTrue(d3==iterator.next());
		assertEquals(true, iterator.hasNext());	}
	
	@Test
	public void testIteratorSuccessfulDoublePrevious() {
		sortedLinkedDouble.add(d5);
		sortedLinkedDouble.add(d6);
		sortedLinkedDouble.add(d1);
		sortedLinkedDouble.add(d4);
		ListIterator<Double> iterator = sortedLinkedDouble.iterator();
		assertTrue(d4==iterator.next());
		assertTrue(d5==iterator.next());
		assertTrue( d1==iterator.next());
		assertEquals(true, iterator.hasPrevious());
		assertTrue(d6==iterator.previous());
		assertTrue( d1==iterator.previous());
		assertEquals(true, iterator.hasPrevious());
	}
